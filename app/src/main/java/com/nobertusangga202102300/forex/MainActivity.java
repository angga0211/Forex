package com.nobertusangga202102300.forex;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idrTextView = (TextView)findViewById(R.id.inrTextView);
